...
import { Menu, X, ChevronDown, ArrowLeft, Sun, Moon } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../contexts/AuthContext';
import { useTheme } from '../contexts/ThemeContext';

export default function SharedNavigation({ title, showBackButton = true }) {
        ...
        <>
            ...
            <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 text-white shadow-2xl bg-gradient-to-r from-blue-700 to-blue-900">
                ...
                <div className="flex items-center gap-4 hidden md:flex">
                    ...
                    <button
                        onClick={() => {
                          console.log('Dark mode button clicked in SharedNav, current state:', isDarkMode);
                          toggleTheme();
                        }}
